...
public class PatientsController : ControllerBase
{
    ...
    public PatientsController(IPatientProfileService patientProfileService, IClinicalDetailsService clinicalDetailsService)
    {
    ...
    {
        return Ok(await _patientProfileService.GetPatientsAsync(searchQuery));
    }

    [HttpGet("{id:int}")]
    public async Task<ActionResult<ApiResponse<PatientDto>>> GetPatient(int id)
    {
        var result = await _patientProfileService.GetPatientByIdAsync(id);
    ...
    {
        var result = await _patientProfileService.GetPatientByPatientIdAsync(patientId);
        return result.Success ? Ok(result) : NotFound(result);
    }
    ...
    {
        return Ok(await _patientProfileService.SearchPatientsAsync(searchTerm, pageNumber, pageSize));
    }

    [HttpGet("generate-id")]
    public async Task<ActionResult<ApiResponse<string>>> GeneratePatientId()
    {
        return Ok(await _patientProfileService.GeneratePatientIdAsync());
    }

    [HttpPost]
    public async Task<ActionResult<ApiResponse<PatientDto>>> CreatePatient([FromBody] CreatePatientDto createPatientDto)
    {
        var result = await _patientProfileService.CreatePatientAsync(createPatientDto);
    ...
    {
        var result = await _clinicalDetailsService.CreatePatientWithClinicalDetailsAsync(createPatientDto);
    ...
    {
        var result = await _patientProfileService.UpdatePatientAsync(id, updatePatientDto);
        return result.Success ? Ok(result) : NotFound(result);
    }

    [HttpPut("{id:int}/with-clinical-details")]
    public async Task<ActionResult<ApiResponse<PatientWithClinicalDetailsDto>>> UpdatePatientWithClinicalDetails(int id, [FromBody] UpdatePatientWithClinicalDetailsDto updatePatientDto)
    {
        var result = await _clinicalDetailsService.UpdatePatientWithClinicalDetailsAsync(id, updatePatientDto);
        return result.Success ? Ok(result) : NotFound(result);
    }
    ...
    {
        var result = await _patientProfileService.DeletePatientAsync(id);
        return result.Success ? Ok(result) : NotFound(result);
    }
}
